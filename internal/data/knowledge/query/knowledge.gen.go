...
func newKnowledge(db *gorm.DB, opts ...gen.DOOption) knowledge {
	...
	_knowledge.ParentID = field.NewInt64(tableName, "parent_id")
	_knowledge.CreateTime = field.NewTime(tableName, "create_time")
...
type knowledge struct {
	...
	Description field.String // 知识点描述
	ParentID    field.Int64  // 父知识点 ID，用于构建知识点树结构
	CreateTime  field.Time   // 创建时间
	UpdatedAt   field.Time   // 更新时间
	DeletedAt   field.Field  // 删除时间，用于软删除
...
func (k *knowledge) updateTableName(table string) *knowledge {
	...
	k.ParentID = field.NewInt64(table, "parent_id")
